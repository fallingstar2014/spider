...
public class Wrapper_gjsairlf001 implements QunarCrawler{
	...
	public BookingResult getBookingInfo(FlightSearchParam arg0) {
		...
		String strAftDate = sdf.format(retDate);
	...
	public String getHtml(FlightSearchParam arg0) {
		...
		NameValuePair[] names81 = {
				...
				new NameValuePair("typetrajet","1"),
	...
	public static void main(String[] args) {
		...
		searchParam.setArr("VTE");
		searchParam.setDepDate("2014-07-10");
		searchParam.setRetDate("2014-08-20");
		searchParam.setTimeOut("60000");
		searchParam.setToken("");
		searchParam.setWrapperid("Wrapper_gjsairlf001");
		
		Wrapper_gjsairlf001 gjdairob001 = new  Wrapper_gjsairlf001();
