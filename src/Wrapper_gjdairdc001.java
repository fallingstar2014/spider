...
public class Wrapper_gjdairdc001 implements QunarCrawler{
	...
	public String getHtml(FlightSearchParam arg0) {
		...
		NameValuePair[] names164 = {
				...
				new NameValuePair("SearchRoundTrip","False"),
		...
		for (int hbh = 0;hbh < hbs;hbh++) {
			String hbbz = "Class=\"Itinerary" + hbh + "TicketNumber0DirectionORIGINPassengerNumer0";
			...
			String json = "{\"DefaultSelectedTickets\":[{\"PassengerIndex\":\"0\",\"Direction\":\"ORIGIN\",\"TicketGUID\":\"" + TicketGUIDs[hbh] + "\",\"PassengerType\":\"Adult\",\"TicketSelector\":\"Itinerary0TicketNumber0DirectionORIGINPassengerNumer0\"}]}";
	...
	public static void main(String[] args) {
		...
		Wrapper_gjdairdc001 gjdairob001 = new  Wrapper_gjdairdc001();
